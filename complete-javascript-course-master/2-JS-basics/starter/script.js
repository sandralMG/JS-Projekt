...
console.log("Is Mark's BMI higher than John's? " + mark_larger);*/
...
var John = {
    ...
    length: 1.57,
    calcBMI: function () {
        this.bmi = this.mass / (this.length * this.length);
        return this.bmi;
    }
};
...
if (Mark.calcBMI() > John.calcBMI()) {
    console.log(Mark.fullName + 'has the largest bmi ' + Mark.calcBMI());
} else if (John.calcBMI > Mark.calcBMI()) {
    console.log(John.fullName + 'has the largest bmi ' + John.calcBMI());
...
(starting from 0). After you have the sum of the array, divide it by the number of e
lements in it (that's how you calculate the average)
