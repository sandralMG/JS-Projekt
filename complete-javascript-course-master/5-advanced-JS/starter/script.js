...
6. Check if the answer is correct and print to the console whether the answer is correct ot 
nor (Hint: write another method for this).
...
(function () {
    ...
    var sports = new Question('Best player', ['Ronaldo', 'Messi'], 'Ronaldo');
    var bible = new Question('Best figure', ['Jesus', 'Moses'], 'Jesus');
    var art = new Question('Best art', ['Picasso', 'Rembrandt'], 'Picasso');

    var questions = [sports, bible, art];

    var n = Math.floor(Math.random() * questions.length);

    questions[n].displayQuestions();

    var answer = prompt('Select the corrects answser');
...
to quit the game if the user writes 'exit' instead of the answer. In this case, DON'T call the function from task 8.

10. Track the user's score to make the game more fun! So each time an answer is correct, 
add 1 point to the score (Hint: I'm going to use the power of closures for this, but you don't have to, just do this with the tools you feel more comfortable at this point).
